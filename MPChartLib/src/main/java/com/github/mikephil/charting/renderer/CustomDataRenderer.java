...
public abstract class CustomDataRenderer extends Renderer {
    ...
    protected TextPaint mDrawTextPaint;
    ...
    public CustomDataRenderer(ChartAnimator animator, ViewPortHandler viewPortHandler) {
        ...
        mDrawTextPaint = new TextPaint();
        mDrawTextPaint.setARGB(0xFF, 0, 0, 0);
        mDrawTextPaint.setTextSize(10.0F);
    ...
    public abstract void drawValueText(Canvas c, TextPaint textPaint, String valueText, float x, float y, int color);
