...
/*
        ...
        //  c.save();
        StaticLayout layout = new StaticLayout(valueText, textPaint, 300,
                Layout.Alignment.ALIGN_NORMAL, 1.0F, 0.0F, true);
        c.save();
        c.translate(0, 0);//从20，20开始画
        layout.draw(c);
...
*/
    ...
    @Override
    public void drawValueText(Canvas c, TextPaint textPaint, String valueText, float x, float y, int color) {
        mValuePaint.setColor(color);
