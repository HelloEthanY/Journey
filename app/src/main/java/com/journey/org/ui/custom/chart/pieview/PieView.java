...
public class PieView extends View {
     ...
     * 起始绘制角度
     */
    private float mStartDegree = PieConfig.DEFAULT_START_DEGREE;
     ...
     * 内透明圆透明度
     */
    private float mAlpha = PieConfig.DEFAULT_CIRCLE_ALPHA;
     ...
     * 中心孔占外圆半径的百分比
     */
    private float mHoleRadiusPercent = PieConfig.DEFAULT_HOLE_RADIUS_PERCENT;

    /**
     * 内透明圆占外圆半径的百分比
     */
    private float mAlphaRadiusPercent = PieConfig.DEFAULT_ALPHA_RADIUS_PERCENT;

    /**
     * 凸起板块之间的间距
     */
    private int mSpace = PieConfig.DEFAULT_BLOCK_SPACE;

    private List<PieEntity> mData;
     ...
     * 版块上的字号
     */
    private int mBlockTextSize = PieConfig.DEFAULT_BLOCK_TEXT_SIZE;

    /**
     * 版块上文字的颜色
     */
    private int mBlockTextColor = PieConfig.DEFAULT_BLOCK_TEXT_COLOR;

    /**
     * 中心字号
     */
    private int mCenterTextSize = PieConfig.DEFAULT_CENTER_TEXT_SIZE;

    /**
     * 中心字颜色
     */
    private int mCenterTextColor = PieConfig.DEFAULT_CENTER_TEXT_COLOR;
     ...
     * 动画时长
     */
    private int mAnimatorTime = PieConfig.DEFAULT_ANIMATOR_TIME;
     ...
     * @param data the data
     */
    public PieView setData(List<PieEntity> data) {
        getData().clear();
        getData().addAll(data);
