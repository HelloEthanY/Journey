...
public class PageChartFragment extends BaseFragment<FragmentPageChartBinding, PageChartViewModel> {
    ...
    private void initPieChart() {
        ...
        entries.add(new PieEntry(5, "很大安科技的安顺大卡机测试1 " + 5 + " 个"));
        entries.add(new PieEntry(10, "大苏打安顺大事大阿大撒测试2 " + 10 + " 个"));
        entries.add(new PieEntry(5, "啊大事按时的啊测试3 " + 5 + " 个"));
        entries.add(new PieEntry(20, "啊大署大测试4 " + 20 + " 个"));
        entries.add(new PieEntry(10, "安顺大是的测试5 " + 10 + " 个"));
        entries.add(new PieEntry(5, "啊时代的按时的按时的测试6 " + 5 + " 个"));
        entries.add(new PieEntry(60, "啊署大按时的安顺测试7 " + 60 + " 个"));
        //将数据装入集合
        ...
        binding.pieChart.setExtraOffsets(0, 10, 0, 10);        //设置pieChart图表上下左右的偏移，类似于外边距
        // 获取pieCahrt图列
