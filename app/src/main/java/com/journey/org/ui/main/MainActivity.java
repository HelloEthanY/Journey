...
import com.journey.org.ui.main.home_travel.HomeTravelFragment;
...
public class MainActivity extends BaseActivity<ActivityMainBinding, BaseViewModel> {
    ...
    private void initFragment() {
        ...
        mFragments.add(new HomeTravelFragment());
    ...
    private void initBottomTab() {
        ...
        item.addItem(R.mipmap.ic_home_trip, getString(R.string.home_travel));
